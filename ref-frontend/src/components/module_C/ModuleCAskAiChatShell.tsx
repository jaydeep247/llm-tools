...
export type ModuleCAskAiChatTurn = {
  id: string
  role: 'user' | 'assistant'
  content: string
  sources?: string[]
...
type ModuleCAskAiChatShellProps = {
  chatScrollRef: Ref<HTMLDivElement>
  chatMessages: ModuleCAskAiChatTurn[]
  chatInput: string
...
export function ModuleCAskAiChatShell({
  chatScrollRef,
  chatMessages,
  chatInput,
  setChatInput,
        ...
        <div className="flex gap-4">
          ...
          <div className="min-w-0 space-y-1.5">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-zinc-400 sm:text-base">
              Ask questions about Module C metrics: LLM friendliness, entity coverage, answer completeness,
              and priority page actions.
            </p>
          </div>
        </div>
      </header>
      ...
      <div ref={chatScrollRef} className="min-h-0 flex-1 space-y-6 overflow-y-auto px-4 py-5 sm:px-8">
          ...
          <div className="mx-auto max-w-2xl space-y-6 py-4">
            <div className="rounded-2xl border border-dashed border-zinc-700/60 bg-zinc-950/50 p-8 text-center">
              ...
              <p className="text-base leading-relaxed text-zinc-400">
                Start with a suggested question or ask anything about AI Visibility Scorecards.
              </p>
            </div>
            <div>
        ...
        {isAskingAI ? (
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/90 px-5 py-4 text-base text-zinc-400">
            Reading your Module C analysis...
          </div>
        ) : null}

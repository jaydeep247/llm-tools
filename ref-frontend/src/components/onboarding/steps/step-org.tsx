...
export function StepOrg({ onNext, onBack, value, onChange, currentStep, totalSteps }: StepOrgProps) {
  const [isOtherSelected, setIsOtherSelected] = useState(() => {
    if (!value) return false
    return !ORG_TYPES.some(r => r.value === value && r.value !== 'Other')
  })
  ...
  return (
    <StepWrapper
      ...
      description="What kind of organization do you work for?"
      onNext={onNext}
      onBack={onBack}
      canProceed={!!value}
      nextLabel="Continue"

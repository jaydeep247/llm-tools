...
EXECUTOR_REGISTRY: Dict[str, ExecutorFn] = {
    ...
    "MODULE_C_C1": execute_module_c_job,
    "MODULE_C_C2": execute_module_c_job,
    "MODULE_C_C3": execute_module_c_job,
    "MODULE_C_C4": execute_module_c_job,
    "MODULE_C_C5": execute_module_c_job,
    "MODULE_C_C6": execute_module_c_job,
    "MODULE_C_C7": execute_module_c_job,
    "MODULE_C_C8": execute_module_c_job,
    "MODULE_C_C9": execute_module_c_job,
    ...
    "MODULE_D_PROMPT_INGEST":   execute_module_d_job,
    "MODULE_D_PROMPT_EXPAND":   execute_module_d_job,
    "MODULE_D_DIFFICULTY":      execute_module_d_job,
    "MODULE_D_PROMPT_LIST":     execute_module_d_job,
    "MODULE_D_CITATIONS":       execute_module_d_job,
    "MODULE_D_PERFORMANCE":     execute_module_d_job,
    "MODULE_D_MANUAL_RUN":      execute_module_d_job,
    "MODULE_D_FEEDBACK":        execute_module_d_job,
    "MODULE_D_HEALTH":          execute_module_d_job,
